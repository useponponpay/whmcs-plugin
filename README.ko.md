# PolyPay WHMCS 결제 게이트웨이 플러그인

[PolyPay](https://polypay.ai)를 통해 WHMCS 결제 시스템에서 암호화폐 결제(USDT, USDC 등)를 받으세요.
...
> **⚠️ 이 플러그인을 설치하기 전에 [polypay.ai](https://polypay.ai)에서 다음 단계를 완료하세요:**

1. **계정 등록** — [https://polypay.ai](https://polypay.ai)에 방문하여 가입
...
3. **PolyPay**를 찾아 **활성화** 클릭
4. [polypay.ai](https://polypay.ai)에서 발급받은 **API Key** 입력
5. **변경사항 저장** 클릭
...
고객 주문 → WHMCS 청구서 생성
    ...
    → 플러그인이 PolyPay API로 결제 주문 생성
    → 고객이 암호화폐 결제 완료
    → PolyPay 콜백 전송 → WHMCS 청구서를 결제 완료로 표시
```
...
| 문제 | 해결 방법 |
|------|-----------|
| "사용 가능한 결제 수단이 없습니다" | [polypay.ai](https://polypay.ai)에서 지갑 추가 및 통화 활성화 확인 |
...
- **PolyPay 콘솔**: [https://polypay.ai](https://polypay.ai)
- **문서**: [https://polypay.ai/docs](https://polypay.ai/docs)
