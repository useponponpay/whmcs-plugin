...
$_POLYPAY_LANG = [
    ...
    'config_mch_id_desc' => 'ID продавца (например, MCH17790986189696), скопируйте его из консоли продавца. Используется как короткий префикс номера заказа продавца; если не указан, используется идентификатор, производный от API ключа.',
    ...
    'redirecting_to_payment' => 'Перенаправление на страницу оплаты...',
